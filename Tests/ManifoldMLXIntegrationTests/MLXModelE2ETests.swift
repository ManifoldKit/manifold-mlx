...
/// - CLI: `xcodebuild test -scheme ManifoldKit-Package -only-testing ManifoldMLXIntegrationTests`
///
...
final class MLXModelE2ETests: XCTestCase {
  ...
  func test_loadModel_strippedTokenizerConfig_throwsModelLoadFailed() async throws {
    ...
    let strippedURL = stagingRoot.appendingPathComponent(
      modelURL.lastPathComponent, isDirectory: true)
