...
final class MLXPromptCacheTrimDeclineTests: XCTestCase {
  ...
  private func emptyStateSnapshot(typeName: String, offset: Int, promptTokens: [Int])
  ...
  func test_restorePromptCache_typeMismatch_declines() {
    let snap = emptyStateSnapshot(
      typeName: "RotatingKVCache", offset: 4, promptTokens: [1, 2, 3, 4])
  ...
  func test_restorePromptCache_emptyState_setsOffsetAndTrimsToReuseLength() {
    let snap = emptyStateSnapshot(
      typeName: "KVCacheSimple", offset: 6, promptTokens: Array(20..<26))
    let live = MLXPromptCache([KVCacheSimple()])
