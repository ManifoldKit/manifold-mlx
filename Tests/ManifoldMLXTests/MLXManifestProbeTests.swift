...
final class MLXManifestProbeTests: XCTestCase {
  ...
  func test_contextWindow_fromRealConfigOnDisk_matchesWhatWouldDriveThePrimaryWarningThreshold()
    throws
  {
    let dir = try makeTempDir()
    try writeConfig(
